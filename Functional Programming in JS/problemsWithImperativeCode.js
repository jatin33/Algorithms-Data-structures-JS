...
// It keeps your code easy to manage, and saves you from sneaky bugs. But before we get there, 
...
// ['FB', 'Gitter', 'Reddit', 'Twitter', 'Medium', 'new tab', 'Netflix', 'YouTube', 'Vine', 'GMail', 'Work mail', 'Docs', 'freeCodeCamp', 'new tab'] but the output will be slightly different.
...
//    ========================================================================
 this.tabs.splice(index,1); // Solution to problem
  return this;
 };
...
// ===============================================================
  // expected output :- ['FB', 'Gitter', 'Reddit', 'Twitter', 'Medium', 'new tab', 'Netflix', 'YouTube', 'Vine', 'GMail', 'Work mail', 'Docs', 'freeCodeCamp', 'new tab']
// actual output before problem was solved :- missing value 'Vine' from result array
