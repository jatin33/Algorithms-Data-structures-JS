...
// Note that the rating values are saved as strings in the object and need 
...
let totalRating = watchList.map((item)=>{
  return {
...
averageRating =  totalRating / watchList.filter((item)=>{
 return item.Director === 'Christopher Nolan';
}).length;
